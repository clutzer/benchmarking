...
runBenchmark() {
    ...
    #Runs
    #for concurrency in 1 2 4 8 16 32 64 128 200; do
    #for concurrency in 1 2 3 8 16 32 64 128 140 150 160 170 180 190 200; do
    for concurrency in 128 140 150 160 170 180 190 200; do
